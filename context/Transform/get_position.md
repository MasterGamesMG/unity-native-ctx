...
| `sub_C5D90`  | `CalculateGlobalPosition` | Directly named in engine IDB |
...
- In x64, `m_CachedPtr` lands at `a1 + 0x70` due to the larger object header and alignment in the engine's internal representation
